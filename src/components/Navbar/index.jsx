                        ...
                        <div className="collapse navbar-collapse" id="navbarNav">
                            <ul className="navbar-nav ">
                                ...
                                <li className="nav-item">
                                    ...
                                    <Link className='a fs-4' to="/"> About</Link>
                                </li>
                                <li className="nav-item">
                            ...
                            <ul className='ms-auto d-flex text-decoration-none'>
                                ...
                                {auth ? (<li className="nav-item">
                                    ...
                                    <Link onClick={logout} className='a fs-2 ' to="/login">login</Link>
                                </li>) : (<li className="nav-item">
                                    <h2 className='text-center text-dark'> <BiLogOutCircle /></h2>
                                    <Link onClick={login} className='a fs-2 ' to="/">logout</Link>
                                </li>)}
